...
const DeleteAircraftModal = ({ isOpen, onClose, onConfirm }) => (
                    ...
                    <Dialog.Panel className="w-full max-w-md p-6 bg-white rounded-lg shadow-lg transform transition-all">
                        ...
                        <div className="mt-2">
                            <p className="text-sm text-gray-500">
                                This action cannot be undone. This will permanently delete the aircraft from your database.
                            </p>
                        </div>
...
export default DeleteAircraftModal;
